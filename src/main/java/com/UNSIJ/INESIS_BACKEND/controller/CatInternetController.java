 ...
 */
@RestController
@RequestMapping("/cat_internet")
public class CatInternetController {
    ...
    public ResponseEntity<?> delete(@PathVariable Long id) {
        try {
            internetServiceJPA.deleteById(id);
            internetServiceJPA.findById(id); // Para lanzar la excepción si no se encuentra el registro
